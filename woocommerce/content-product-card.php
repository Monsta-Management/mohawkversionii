...
<div class="col-sm-2 product-item-wrap" data-new="<?=$infocommunique?>" supplier="<?=$supplier?>" data-rank="<?=$rank;?>">
	<div class="product-item product-card"
		...
		<?php if ( $trophymonsta_image ) : ?>
			data-image-url="<?php echo esc_url( $trophymonsta_image ); ?>"
		<?php endif; 						// SPINNING video/image display END. ?>
	>
		...
		<div class="product-inner">
			...
			<div class="product-inner-link">
				<div class="row">
					<div class="col-sm-6">
						<a class="btn btn-success btn-sm btn-block " href="<?php echo esc_url( get_permalink() ); ?>">VIEW PRODUCT</a>
					</div>
				</div>
			</div>
